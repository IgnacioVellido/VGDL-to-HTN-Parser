...
spriteDefinition
  : name=WORD WS* '>' WS* type=WORD? parameter* INDENT (WS* spriteDefinition NL?)+ DEDENT # RecursiveSprite
  | name=WORD WS* '>' WS* type=WORD? parameter*   # NonRecursiveSprite
...
interaction
  : sprite1=WORD list_sprite2=WORD+ WS* '>' type=WORD parameter* 
  ;
